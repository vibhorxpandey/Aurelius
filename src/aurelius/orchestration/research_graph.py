...
from ..agents.execution import CodeGeneratorAgent, ExperimentDesignerAgent
...
from ..agents.publication import DraftPaperAgent, LatexFormatterAgent, ProofOfRigorAgent
from ..agents.verification import AdversarialReviewerAgent, CitationVerifierAgent
...
def build_research_graph(
    ...
    *,
    ...
    g.add_node("execute_sandbox", placeholders.sandbox_executor())
    g.add_node("audit_methodology", placeholders.methodology_auditor())
    ...
    g.add_node("update_living_doc", placeholders.living_doc_versioner())
    ...
    linear = [
        ...
        ("execute_sandbox", "audit_methodology"),
